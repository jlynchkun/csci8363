...
function pipeline(clustering_data, df_data)

figure
subplot(1,2,1)
svd_singular_value_plot(clustering_data.X1, clustering_data.labels)
subplot(1,2,2)
svd_singular_value_plot(clustering_data.X2, clustering_data.labels)
...
if df_data.skip == true
  ...
  dual_factorization(df_data.X1, df_data.X2, df_data.X2_self_associations, df_data.labels, df_data.parameters, df_data.K, df_data.dataname);
end
